# Generated by Django 3.1.6 on 2021-02-09 16:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(blank=True, choices=[(None, '(Unknown)'), ('HM', 'Home'), ('EL', 'Electronics'), ('FS', 'Fashion'), ('HB', 'Health & Beauty'), ('GR', 'Motors'), ('CL', 'Collectibles'), ('SP', 'Sports'), ('GA', 'Garden'), ('DE', 'Deals'), ('UT', 'Under $10'), ('PT', 'Pets'), ('TY', 'Toys'), ('OT', 'Others')], default='(Unknown)', max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('listing', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='listing_photos', to='auctions.listing')),
            ],
        ),
        migrations.CreateModel(
            name='Notification',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('datetime', models.DateTimeField(auto_now_add=True)),
                ('username', models.CharField(max_length=255)),
                ('bid', models.DecimalField(blank=True, decimal_places=2, max_digits=19)),
