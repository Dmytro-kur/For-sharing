    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(blank=True, choices=[('HM', 'Home'), ('EL', 'Electronics'), ('FS', 'Fashion'), ('HB', 'Health & Beauty'), ('GR', 'Motors'), ('CL', 'Collectibles'), ('SP', 'Sports'), ('GA', 'Garden'), ('DE', 'Deals'), ('UT', 'Under $10'), ('PT', 'Pets'), ('TY', 'Toys'), ('OT', 'Others')], max_length=2)),
