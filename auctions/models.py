...
class Bid(models.Model):
    ...
    def __str__(self):
        return f"{self.username} makes a bid on {self.listings} listing: ${float(self.bid):.2f}"
...
class Listing(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name="listings_for_user")
    ...
    current_price = models.ForeignKey(Bid, on_delete=models.CASCADE, related_name="listings_for_bid")
